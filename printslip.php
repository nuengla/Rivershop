...
<div class='trow'>
		<table  align="center"  class="slip">
         <thead>
            ...
            <tr>
                <td colspan="8" align="center"><h1>ใบเสร็จรับเงิน</h1><h4>RIVER@WANGLANG</h4></td>
            </tr>
           <tr> 
               <td colspan="8"  align="right">150/107  หมู่บ้านสว่างจิต ซอยสวนผัก 2 ถนนสวนผัก<br>
...
เบอร์โทรศัพท์ : <?php echo $row1["mem_tel"];?><br>
	  ...
	  <td align="right" width="100"><strong> ราคารวม(บาท) </strong></td>
		...
		<?php 
             ...
             <?php
                echo "<tr>";
                echo "<td colspan='4'style='text-align:left'>ผู้รับเงิน : นายนราธิป อาชวโศภณ</td>";
                echo "<td colspan='4' style='text-align:left'>ผู้จ่ายเงิน : ".$row1["mem_name"]."</td>";
                echo "</tr>";
