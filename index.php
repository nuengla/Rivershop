...
<body>
    ...
    <div class="container">
                    ...
                    <a href="?pro_new=1&pro_select=สินค้ามาใหม่">
                        <font color="black">
                            <h4> สินค้ามาใหม่ (NEW)<span>
                                    <img src="img_web/new.png" style="width:35px;height:30px;"></h4>
                        </font>
                    </a><br>
                    <hr><br>
                ...
                <div align="center" class="link2">
                    <table>
                        ...
                        while ($row2 = mysqli_fetch_array($result2)) { ?>
                            <tr>
                                <td align="left"><a href="index.php?pt_id=<?php echo $row2["pt_id"]; ?>&pro_select=<?php echo $row2["pt_name"]; ?>">
        ...
        WHERE p_name LIKE '%$search%'  GROUP BY p_code";
            ...
            elseif(empty($pro_new)&&empty($search)&&empty($pro_pro)&&empty($pt_id)&&empty($pro_top)){
